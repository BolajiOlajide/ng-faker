...
var alphaNumericChars = require('./fixtures');
var hexaDecimalChars = require('./fixtures');
...
function Random(ngFaker) {
  ...
  this.objectElement = function (object) {
    object = object || { 'moin': 'moin', 'sharp': 'sharp' };
  ...
  this.alphanumeric = function alphanumeric(count) {
    ...
    for (var i = 0; i < count; i++) {
      hexadecimalChar += ngFaker.random.arrayElement(alphaNumericChars);
    }
  ...
  this.hexaDecimal = function hexaDecimal(count) {
    ...
    var randomHex = '';
    for (var i = 0; i < count; i++) {
      randomHex += ngFaker.random.arrayElement(hexaDecimalChars);
    }
    return '0x' + randomHex;
  };
